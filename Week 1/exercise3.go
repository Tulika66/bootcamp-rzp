...
// Employee interface is implemented by the FullTime employee
func (fte FullTime) salary()float64{
	return fte.basic * float64(fte.noOfMonths) * float64(28)
}
// Employee interface is implemented by the Contractor type employee
...
func CalculateNetLiability(employees[] Employee)float64{
